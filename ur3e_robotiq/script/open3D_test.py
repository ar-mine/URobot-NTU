...
class MoveGroup(object):
    def __init__(self):
        ...
        display_trajectory_publisher = rospy.Publisher('/move_group/display_planned_path',
                                                       ...
                                                       queue_size=20)
        skeleton_sub = rospy.Subscriber("/nuitrack/skeletons", SkeletonDataArray,
                                        self._skl_callback, queue_size=1)
...
def task():
    move = MoveGroup()
    for i in range(3):
        joint_goal = move.get_joint_state()
        joint_goal[0] = 4.0
        move.go_to_joint_state(joint_goal)
